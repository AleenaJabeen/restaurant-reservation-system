    ...
    <>
      <section className={styles.goalsSection}>
        ...
        <div className={styles.cuisine}>
          ...
          <p>
            Relax and unwind in a cozy, welcoming environment. Our restaurant is
            designed to offer a comfortable space, whether you're enjoying a
            quiet dinner or celebrating a special occasion.
          </p>
