...
<div className={styles.chef}>
    ...
    <p>We believe in serving dishes made from the freshest ingredients. Each ingredient is carefully selected to ensure top quality, delivering flavors that make every bite unforgettable.</p>
